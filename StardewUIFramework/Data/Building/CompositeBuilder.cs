...
namespace UIFramework.Data.Building
{
    ...
    internal sealed class TemplateArgs
    {
        ...
        internal static DataValue Coerce(DataValue value, string? type)
        {
            ...
            {
                "number" or "int" or "integer" or "double" => value.Kind == DataKind.Number ? value : DataValue.FromNumber(value.AsNumber()),
                "bool" or "boolean" => value.Kind == DataKind.Bool ? value : DataValue.FromBool(value.AsBool()),
                "string" or "text" => value.Kind == DataKind.String ? value : DataValue.FromString(value.AsString()),
                _ => value
            };
        }
