...
namespace UIFramework.Data.Expressions
{
    ...
    internal static class ExpressionScope
    {
        ...
        internal static IExpressionScope Empty { get; } = new NullScope();
    }

    /// <summary>The scope that resolves nothing (<see cref="ExpressionScope.Empty"/>).</summary>
    internal sealed class NullScope : IExpressionScope
    {
